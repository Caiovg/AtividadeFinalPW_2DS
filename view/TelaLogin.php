        ...
        <div class="w-50 h-100 mx-auto bg-white login">
            ...
            <form action="../controller/validarLogin.php" method="POST" id="login">
                <div class="form-row col-10 mx-auto mt-5">
                    ...
                    placeholder="Digite aqui seu email ou usuário" name="name" id="user" value="">
                    <div class="col-4"></div>
                </div>
                ...
                <div class="form-row col-10 mx-auto mt-5 mb-5">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <a class="nav-link lead text-center btn btn-primary btn-lg active" role="button" href="TelaCadastro.php">Cadastra-se</a>                           
                        </div>
                    </div>                                                                                          
            </form>
        </div>
